<template>
  <div>
    <div v-if="edit">
      ...
      <div class="form-row">
        <dt-string label="Präfix" class="col-md-2" :value.sync="resourceData.prefix" :edit="edit" />
        <dt-string-array label="Vorname" class="col-md-4" :value.sync="resourceData.given" :edit="edit" />
        <dt-string label="Nachname" class="col-md-4" :value.sync="resourceData.family" :edit="edit" />
